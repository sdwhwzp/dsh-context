...
export const DICT_ZH: Record<string, string> = {
  ...
  'ov.range.label': '统计范围',
  'ov.range.7d': '近 7 天', 'ov.range.30d': '近 30 天', 'ov.range.all': '全部',
...
export const DICT_EN: Record<string, string> = {
  ...
  'ov.range.7d': 'Last 7 days', 'ov.range.30d': 'Last 30 days', 'ov.range.all': 'All',
  ...
  'balance.tip.total': 'Total balance',
